    ...
    return (
        ...
        <form action="" className="newCustomer" onSubmit = {handleSubmit(Submit)}>
                <div className="Item">
                    ...
                    <input type="text" placeholder = "EE XX XX XX" required  {...register('cin',{required:true,maxLength:8})} />
                ...
                <div className="Item">
                    ...
                    <input type="text" placeholder = "put name" autoComplete = "off" required {...register('name',{required:true,maxLength:30})} />
                ...
                <div className="Item">
                    ...
                    <input type="email" placeholder = "xyz@gmail.com" {...register('email',{required:true,maxLength:30})} />
                ...
                <div className="Item">
                    ...
                    <input type="text" placeholder = "06 XX XX XX XX" required {...register('phone',{required:true,maxLength:10})} />
                ...
                <div className="Item">
                    ...
                    <input type="text" placeholder = "put location" required {...register('location',{required:true,maxLength:30})} />
